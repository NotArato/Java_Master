...
public class Undergraduate extends Student {	// Undergraduate class is a subclass of Student class, which means it inherits all the properties and methods of Student class and can also have its own properties and methods.
	...
	public Undergraduate(String initialName, int initialStudentNumber, int initialLevel) { // constructor with parameters
		super(initialName, initialStudentNumber);        
		setLevel(initialLevel); //checks 1 <= initialLevel <= 4    
	}

	public void reset(String newName, int newStudentNumber, int newLevel) { // method to reset the name, student number, and level of the undergraduate student
	...
	public void setLevel(int newLevel)    {	// method to set the level of the undergraduate student
		if ((1 <= newLevel) && (newLevel <= 4))           
			...
			System.out.println("Illegal level!");	// if the new level is not between 1 and 4, print an error message and exit the program
			System.exit(0);       
		}    
	} 

	public void writeOutput()    { // method to write the name, student number, and level of the undergraduate student
		super.writeOutput();        
		System.out.println("StudentLevel: " + level);    
	} 

	public boolean equals(Undergraduate otherUndergraduate) { // method to compare the name, student number, and level of this undergraduate student with another undergraduate student
